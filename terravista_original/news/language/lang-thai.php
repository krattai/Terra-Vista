...
/*****************************************************/
/* NEW FIELDS BY KULAPALANONT                    */
/*****************************************************/
define("_WELCOME","ขอต้อนรับคุณ");
$locale = "th_TH.tis620"; 


/*****************************************************/
/* NEW FIELDS BY CROCKET                             */
/*****************************************************/

define("_ULANGUAGE","ภาษา");
define("_COMPANY","บริษัท");
define("_ADDRESS1","ที่อยู่");
define("_ADDRESS2","ที่อยู่");
define("_ZIP","รหัสไปรษณีย์");
define("_CITY","เมือง");
define("_COUNTRY","ประเทศ");
define("_TEL","โทร.");
define("_FAX","แฟกซ์");
define("_OPTIN","ข่าวสาร");
define("_OPTINNEWSLETTER","ตกลง ขอรับข่าวสาร");
define("_","");
define("_","");
...
define("_POLLS","ความเห็นต่างๆ");


/* COPY THESE LINES IN EVERY LANGUAGE FILE AND TRANSLATE THEM */
...
/* END NEW LINES FOR THE LANGUAGE FILES */
...
define("_OTHEROPTIONS","ตัวเลือกอื่นๆ");
define("_GOBACK","[ <a href=\"javascript:history.go(-1)\">Go Back</a> ]");
define("_GOBACK2","ย้อนกลับ");
...
define("_NOANONCOMMENTS","ผู้ไม่ลงทะเบียน ไม่มีสิทธิ์แสดงความเห็น , โปรด <a href=\"user.php\">ลงทะเบียน</a>");
...
define("_DUPLICATE","ช้ำช้อน. สงสัยคุณกด ส่ง ซ้ำ?");
define("_COMMENTSBACK","ย้อนกลับไปที่ แสดงความเห็น");
...
define("_MPROBLEM","มีปัญหาบางอย่างเกิดขึ้น!");
define("_CATEGORIES","ประเภท");
define("_WAITINGCONT","เนื้อหารอการอนุมัติ");
define("_SUBMISSIONS","เรื่องส่งเข้ามา");
define("_WREVIEWS","บทวิจารณ์");
define("_WLINKS","Links ส่งเข้ามา");
define("_EPHEMERIDS","Ephemerids");
define("_ONEDAY","วันนี้ในอดีต...");
define("_ASREGISTERED","ถ้าท่านยังไม่ได้เป็นสมาชิก? ท่านสามารถ <a href=\"user.php\">สมัครได้ที่นี่</a>. ในการเป็นสมาชิก ท่านจะได้ประโยชน์จากการตั้งค่าส่วนตัวต่างๆ เช่น ฉากหรือพื้นโปรแกรม ค่าอ่านความคิดเห็น และการแสดงความเห็นด้วยชื่อท่านเอง");
define("_MENUFOR","เมนูสำหรับ");
define("_NOBIGSTORY","ยังไม่มีข่าวใหญ่สำหรับวันนี้.");
define("_BIGSTORY","เรื่องที่คนอ่านมากที่สุดคือ :");
define("_TODAYBIG","ข่าวใหญ่ประจำวัน");
...
define("_MEMBERS","สมาชิก เข้าชม .");
define("_WHOSONLINE","ผู้เข้าชม");
define("_YOUARELOGGED","ท่านใช้ชื่อสมาชิกว่า");
define("_YOUHAVE","คุณมี");
define("_PRIVATEMSG","ข้อความใหม่");
define("_YOUAREANON","ท่านยังไม่ได้ลงทะเบียนเป็นสมาชิก หากท่านต้องการ กรุณาสมัครฟรีได้<a href=\"user.php\">ที่นี่</a>");

/*****************************************************/
/* Members List texts                                */
/*****************************************************/

define("_MEMBERSLIST","Member Lists");
define("_GREETINGS","ยินดีต้อนรับคุณ");
define("_SORTBY","จัดเรียงตาม:");
define("_MNICKNAME","ชื่อเรียก");
define("_MREALNAME","ชื่อจริง");
define("_MEMAIL","อีเมล์");
define("_MURL","url");
define("_ONLINEREG","สมาชิกที่ online ขณะนี้คือ:");
define("_WEHAVE","เรามีสมาชิกทั้งหมด");
define("_MREGISTERED","คน และจำนวนสมาชิก online ");
define("_MREGONLINE","คน");
define("_REGSOFAR","สมาชิกทั้งหมด");
define("_USERSFOUND","สมาชิกที่");
define("_MPAGES","หน้า");
define("_USERSSHOWN","พบว่ามีผู้ใช้");
define("_NOMEMBERS","ไม่พบว่ามีสมาชิกชื่อ");
...
define("_NAMEPRODUCT","เรื่องของสิ่งที่วิจารณ์.");
...
define("_10MOSTPOP","10 เรื่องวิจารณ์ที่นิยมอ่านมากที่สุด");
define("_10MOSTREC","10 เรื่องวิจารณ์ล่าสุด");
...
define("_SUBMITNEWS","เผยแพร่เรื่องหรือข้อความ");
...
define("_DOWNLOADS","ดาวโหลด");

/*****************************************************/
/* User's System texts                               */
/*****************************************************/

define("_ERRORINVEMAIL","ERROR: อีเมล์ไม่ถูกต้อง ");
define("_ERROREMAILSPACES","ERROR: อีเมล์ต้องไม่มีช่องว่าง ");
define("_ERRORINVNICK","ERROR: ชื่อเรียกไม่ถูกต้อง");
define("_NICK2LONG","ชื่อเรียก นี้ยาวเกินกว่า 25 ตัวอักษรที่อนุญาติ");
define("_NAMERESERVED","ERROR: ชื่อนี้ถูกจองแล้ว");
define("_NICKNOSPACES","ERROR: ไม่อนุญาติให้มีช่องว่างในชื่อเรียก ");
define("_NICKTAKEN","ERROR: ชื่อนี้ถูกใช้ไปแล้ว");
define("_EMAILREGISTERED","ERROR: อีเมล์นี้ถูกนำมาใช้แล้ว ");
...
define("_YOURPASSIS","รหัสผ่านของท่านคือ:");
define("_2CHANGEINFO","ต้องการเปลี่ยนข้อมูล ");
...
define("_MYHOMEPAGE","HomePage ส่วนตัว:");
define("_MYEMAIL","Email ส่วนตัว:");
...
define("_LOGININCOR","Login ไม่ถูกต้อง โปรดพยายามใหม่...");
define("_USERLOGIN","สมาชิก Login");
define("_USERREGLOGIN","สมัครสมาชิกใหม่ และ สมาชิก Login");
...
define("_SHOWSIGNATURE","แสดงลายเซ็น");
...
define("_ADDLINK","เพิ่ม Link");
define("_NEW","Link ใหม่");
define("_POPULAR","Link ยอดนิยม");
define("_TOPRATED","นิยมสุด ");
define("_RANDOM","สุ่มโชว์ Link ");
define("_LINKSMAIN","เมนู Links ");
define("_LINKCOMMENTS","ความเห็นต่อ Link");
define("_ADDITIONALDET","รายละเอียดเพิ่มเติม");
define("_EDITORREVIEW","บรรณาธิการพิจารณา");
define("_REPORTBROKEN","รายงาน Broken Link");
define("_LINKSMAINCAT","ดัชนี Links");
define("_AND","และ");
define("_INDB","ในฐานข้อมูลนี้");
define("_ADDALINK","เพิ่ม Link ใหม่");
define("_INSTRUCTIONS","คำแนะนำ");
define("_SUBMITONCE","ส่งแต่ละ  link  เพียงครั้งเดียว");
define("_POSTPENDING","ทุก links จะต้องผ่านการตรวจสอบก่อนเผยแพร่");
...
define("_LINKSNOTUSER8","<a href=\"user.php\">สมัครสมาชิก</a>");
define("_LINKALREADYEXT","ERROR: URL นี้มีอยู่ในฐานข้อมูลแล้ว");
define("_LINKNOTITLE","ERROR: ท่านต้องพิมพ์ ชื่อ Page สำหรับ URL นี้! ");
define("_LINKNOURL","ERROR: ท่านต้องพิมพ์  URL สำหรับ URL นี้!");
define("_LINKNODESC","ERROR: ท่านต้องพิมพ์  รายละเอียดสำหรับ URL นี้!!");
define("_LINKRECEIVED","เราได้รับ Link ที่ท่านส่งมาแล้ว ขอบคุณมาก!");
define("_EMAILWHENADD","ท่านจะได้รับ อีเมล์ เมื่อผ่านการอนุมัติ");
define("_CHECKFORIT","ท่านไม่ได้ระบุ อีเมล์ อย่างไรก็ตาม  เราจะทำการตรวจสอบ link ที่เสนอมา ในภายหลัง");
define("_NEWLINKS","Links ใหม่");
define("_TOTALNEWLINKS"," Links ใหม่ทั้งหมด");
define("_LASTWEEK","สัปดาห์ที่แล้ว");
define("_LAST30DAYS","ช่วง 30 วันที่แล้วมา");
define("_1WEEK","1 สัปดาห์");
define("_2WEEKS","2 สัปดาห์");
define("_30DAYS","30 วัน");
define("_SHOW","แสดง");
define("_TOTALFORLAST","Link ใหม่ทั้งหมดใน");
define("_DAYS","วัน");
define("_ADDEDON","Added on");
define("_VOTE","จำนวนผู้เขียนแนะนำ");
define("_VOTES","จำนวนผู้ลงคะแนน");
define("_RATING","คะแนน");
define("_RATESITE","ให้คะแนน");
define("_DETAILS","รายละเอียด");
define("_BESTRATED","Linksดีที่สุด - Top");
define("_OF","ของ");
define("_TRATEDLINKS","link ทั้งหมดที่ได้คะแนน");
define("_TVOTESREQ","ที่ได้คะแนนอย่างต่ำ ");
define("_SHOWTOP","แสดงยอด ");
define("_MOSTPOPULAR","ที่ได้รับความนิยมสุด  - Top");
define("_OFALL","ของทั้งหมด");
define("_LALSOAVAILABLE","Links ยังคงมีที่ ");
define("_SUBCATEGORIES","หมวดแยกย่อย");
define("_SORTLINKSBY"," เรียงลำดับตาม");
define("_SITESSORTED","Sites เหล่านี้เรียงตาม ");
...
define("_RATETHISSITE","Rate this Website");
...
define("_DOWNLOADADMIN","Downloads Administration");
define("_ACTIVEDOWN","Current Active Downloads");
define("_COUNTER","Counter");
define("_FILENAME","Filename");
define("_ADDDOWNLOAD","Add Download");
define("_DOWNLOADURL","Download URL");
define("_OWNERHOMEPAGE","Owner HomePage");
define("_EDITDOWNLOAD","Edit Download");
define("_DCHANGEDATE","Change Date?");


define("_DOWNLOADDELWARNING","WARNING: Are you sure you want to delete this Download file?");
