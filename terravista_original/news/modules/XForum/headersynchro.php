...
// Recup des mots de passe et login
if ($SYSADMIN) 
{
...
if ($SYSADMIN) 
  {
	#echo "admin $thisuser connecté";
	$res2 = mysql_query("select uid from $table_members where username='$thisuser'");
	$isreg = mysql_num_rows($res2);

	$res3 = mysql_query("select aid, url, email, pwd  from ".$prefix."_authors where aid='$thisuser'") or die(mysql_error());

	if ($isreg==0)
	{	
 	  # admin non déjà enregistré
	  list($xmb_username, $xmb_site, $xmb_email, $xmb_password) = mysql_fetch_row($res3);
	  ...
	  $result = mysql_query("INSERT INTO $table_members VALUES (NULL, '$xmb_username', '$xmb_password', '$xmb_regdate', '$xmb_postnum', '$xmb_email', '$xmb_site', '$xmb_aim', '$xmb_status', '$xmb_location', '$xmb_bio', '$xmb_sig', '$xmb_showemail', '$xmb_timeoffset', '$xmb_icq', '$xmb_avatar', '$xmb_yahoo', '$xmb_customstatus', '$xmb_theme', '$xmb_bday', '$xmb_langfile', '$xmb_tpp', '$xmb_ppp', '$xmb_newsletter', '$xmb_regip', '$xmb_timeformat', '$xmb_msn', '$xmb_dateformat', '$xmb_ignoreu2u', '$xmb_lastvisit')");
	}
	else
	# admin déjà enregistré : on met à jour les tables de xmb 
	{
	  list($xmb_username, $xmb_site, $xmb_email, $xmb_password) = mysql_fetch_row($res3);

	  $result = mysql_query("UPDATE $table_members set password='$xmb_password',  email='$xmb_email', site='$xmb_site'  where username = '$xmb_username' ");
	}
  }
elseif ($USER) 
  {
	...
	$res3 = mysql_query("select uname, user_avatar, pass, email, url, user_aim, user_from, user_occ, user_sig, user_icq, user_yim, user_msnm  from ".$prefix."_users where uname='$thisuser'") or die(mysql_error());

	if ($isreg==0)
	{	
 	  # user non déjà enregistré
	  list($xmb_username, $xmb_avatar, $xmb_password, $xmb_email, $xmb_site, $xmb_aim, $xmb_location, $xmb_bio, $xmb_sig, $xmb_icq, $xmb_yahoo, $xmb_msn) = mysql_fetch_row($res3);

	  $xmb_showemail = "no";
	  #$xmb_avatar = "images/avatar/".$xmb_avatar;
	  $xmb_regdate = time();
	  $xmb_postnum = "0";
	  $xmb_status = "Member";
	  $xmb_customstatus = "";
	...
	{
	  # Nuke user: déjà enregistré : on met à jour les tables de xmb (avatar maj 20011001)
	  list($xmb_username, $xmb_avatar, $xmb_password, $xmb_email, $xmb_site, $xmb_aim, $xmb_location, $xmb_bio, $xmb_sig, $xmb_icq, $xmb_yahoo, $xmb_msn) = mysql_fetch_row($res3);

	  $result = mysql_query("UPDATE $table_members set password='$xmb_password',  email='$xmb_email', site='$xmb_site', aim='$xmb_aim', location='$xmb_location', bio='$xmb_bio', sig='$xmb_sig', icq='$xmb_icq', yahoo='$xmb_yahoo', msn='$xmb_msn', avatar='$xmb_avatar'  where username = '$xmb_username' ");
	}
