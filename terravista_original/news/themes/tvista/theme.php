...
<a href=$nuke_url><img src=themes/tvista/images/logo.gif Alt=\"".translate("Welcome to")." $sitename\" border=0></a>
...
function themeindex ($aid, $informant, $datetime, $title, $counter, $topic, $thetext, $notes, $morelink, $topicname, $topicimage, $topictext) {
	...
	if ("$aid" == "$informant") { ?>
		<table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF"><tr valign="top" bgcolor="#101070">
			<td><img src="themes/tvista/images/cl.gif" width="7" height="10" alt=""><img src="themes/tvista/images/pix.gif" width="4" height="4" alt=""></td>
			<td width="100%">
			<table width="100%" border="0" cellpadding="2" cellspacing="0"><tr><td>
			<font class="storytitle"><B><?php echo"$title"; ?></B></font>
			</td></tr></table>
			</td><td align="right"><img src="themes/tvista/images/pix.gif" width="4" height="4" alt=""><img src="themes/tvista/images/cr.gif" width="7" height="10" alt=""></td>
         	</tr></table>
		<table border="0" cellpadding="0" cellspacing="0"><tr bgcolor="#e6e6e6">
			<td background="themes/tvista/images/gl.gif"><img src="themes/tvista/images/pix.gif" width="11" height="11" alt=""></td>
			<td width="100%">
			...
			<td background="themes/tvista/images/gr.gif"><img src="themes/tvista/images/pix.gif" width="11" height="11" alt=""></td>
		</tr>
		<tr bgcolor="#101070"><td colspan="3"><img src="themes/tvista/images/pix.gif" width="1" height="1"></td></tr>
		<tr bgcolor="#ffffff">
			<td background="themes/tvista/images/wl.gif"><img src="themes/tvista/images/pix.gif" width="11" height="11" alt=""></td>
			...
			<?php echo "<font class=content>$thetext"; ?>
                 ...
                 <td background="themes/tvista/images/wr.gif"><img src="themes/tvista/images/pix.gif" width="11" height="11" alt=""></td>
		</tr>
		<tr bgcolor="#101070"><td colspan="3"><img src="themes/tvista/images/pix.gif" width="1" height="1"></td></tr>
		</table><table border="0" cellpadding="0" cellspacing="0">
		<tr bgcolor="#ffffff">
			<td background="themes/tvista/images/wl_cccccc.gif"><img src="themes/tvista/images/pix.gif" width="11" height="11" alt=""></td>
			<td width="100%">
			<table width="100%" border="0" cellpadding="5" cellspacing="0"> 
			<tr><td bgcolor="#cccccc"><font class="content"><?php echo"$morelink"; ?></font></td></tr></table>
			</td>
			<td background="themes/tvista/images/wr_cccccc.gif"><img src="themes/tvista/images/pix.gif" width="11" height="11" alt=""></td>
		</tr>
		<tr bgcolor="#101070"><td colspan="3"><img src="themes/tvista/images/pix.gif" width="1" height="1"></td></tr>
		</table><BR><BR>
<?php	} else {
...
?>		<table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF"><tr valign="top" bgcolor="#101070">
			...
			<font class="storytitle"><B><?php echo"$title"; ?></B></font>
                 	...
                 	<td align="right"><img src="themes/tvista/images/pix.gif" width="4" height="4" alt=""><img src="themes/tvista/images/cr.gif" width="7" height="10" alt=""></td>
         	</tr></table>
		<table border="0" cellpadding="0" cellspacing="0"><tr bgcolor="#e6e6e6">
			<td background="themes/tvista/images/gl.gif"><img src="themes/tvista/images/pix.gif" width="11" height="11" alt=""></td>
			<td width="100%">
...
function themesidebox($title, $content) {
	...
	<tr valign="top" bgcolor="#101070">
		<td bgcolor="#FFFFFF"><img src="themes/tvista/images/pix.gif" width="3" height="3" alt=""></td>
		<td><img src="themes/tvista/images/cl.gif" width="7" height="10" alt=""></td>
		<td><font class="btiny"><B><?php echo"$title"; ?></B></font></td>
		<td align="right"><img src="themes/tvista/images/cr.gif" width="7" height="10" alt=""></td>
		<td bgcolor="#FFFFFF" align="right"><img src="themes/tvista/images/pix.gif" width="3" height="3" alt=""></td>
	</tr>
	</table>
	<table width="100%" border="0" cellpadding="0" cellspacing="0">
	<tr bgcolor="#101070"><td colspan="3"><img src="themes/tvista/images/pix.gif" width="1" height="1"></td></tr>
	<tr bgcolor="#ffffff">
		<td background="themes/tvista/images/sl.gif"><img src="themes/tvista/images/pix.gif" width="3" height="3" alt=""></td>
		<td width="100%">
		<table width="100%" border="0" cellpadding="5" cellspacing="0"><tr><td><font class=tiny><?php echo"$content"; ?>
		</td></tr></table></td>
		<td background="themes/tvista/images/sr.gif" align="right"><img src="themes/tvista/images/pix.gif" width="3" height="3" alt=""></td>
	</tr>
	<tr bgcolor="#101070"><td colspan="3"><img src="themes/tvista/images/pix.gif" width="1" height="1"></td></tr>
	</table><br><br>
<?php
