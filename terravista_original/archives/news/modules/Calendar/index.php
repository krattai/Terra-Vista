...
function printAppt($sql) {
		...
		href=\"modules.php?op=modload&name=$module_name&file=index&type=view&eid=$eid\"
...
function buildYear($Date) {
	OpenTable();
        ...
        print("\n\t<TD width=100><FONT FACE=ARIAL SIZE=2><a href=\"modules.php?op=modload&name=$module_name&file=index&Date=$Prev_Date&type=year\"><<< "._CALPREVIOUS."</a></TD>");
        ...
        print("\n\t<TD width=100 align=right><FONT FACE=ARIAL SIZE=2><a href=\"modules.php?op=modload&name=$module_name&file=index&Date=$Next_Date&type=year\">"._CALNEXT." >>></a></TD>");
        ...
        for ($i=1;$i<13;$i++) {
                ...
                print("\n<TR bgcolor=$trimbgcolor>\n\t<TH colspan=7><FONT SIZE=1 color=$trimtextcolor><a href=\"modules.php?op=modload&name=$module_name&file=index&Date=$i/1/$Date_Array[2]&type=month\">");
                ...
                for ($day = 1 ; $day <= $Last_Day ; $day++) {
                        ...
                        if (($day == $Today_d) && ($Date_Array[0] == $Today_m) && ($Date_Array[2] == $Today_y))
                                print("\n\t<TD width=10 align=center bgcolor=$selecteddaycolor><FONT FACE=ARIAL color=$yeartextcolor SIZE=1><a href=\"modules.php?op=modload&name=$module_name&file=index&Date=$Date_Array[0]/$day/$Date_Array[2]&type=day\">$day</a></TD>");
                        else
                                print("\n\t<TD width=10 align=center bgcolor=$yearbgcolor><FONT FACE=ARIAL color=$yeartextcolor SIZE=1><a href=\"modules.php?op=modload&name=$module_name&file=index&Date=$Date_Array[0]/$day/$Date_Array[2]&type=day\">$day</a></TD>");
                        if ($day_of_week == 7) {
                                $day_of_week = 0;
                                print("\n</TR>");
                                }
...
function addTimeRange($startTime,$endTime,$year,$month,$day) {
	...
	'$year-$month-$day' AND alldayevent='0' AND startTime >= '$startTime' AND startTime <
	'$endTime') ORDER BY startTime, endTime ASC;";
...
function buildDay($Date) {
	...
	OpenTable();
        ...
        if ($Date_Array[2] < 1970)
                ...
                print("\n\t<TD width=100><FONT FACE=ARIAL SIZE=2><a href=\"modules.php?op=modload&name=$module_name&file=index&Date=$Prev_Date&type=day\"><<< "._CALPREVIOUS."</a></TD>");
                print("\n\t<TD align=center><FONT size=5>");
                ...
                print("\n\t<TD width=100 align=right><FONT FACE=ARIAL SIZE=2><a href=\"modules.php?op=modload&name=$module_name&file=index&Date=$Next_Date&type=day\">"._CALNEXT." >>></a></TD>");
                print("\n</TR>\n</TABLE>");
		...
		print("\n\t\t<FONT COLOR=$daytextcolor SIZE=2>Morning</FONT>");
                $sql = "SELECT eid, title, startTime, endTime, barcolor FROM $prefix".nuke_events." WHERE
		(eventDate<='$Date_Array[2]-$Date_Array[0]-$Date_Array[1]' AND endDate >=
		'$Date_Array[2]-$Date_Array[0]-$Date_Array[1]' AND alldayevent='0' AND startTime < '$times[0]') ORDER BY startTime, endTime ASC";
                printAppt($sql);
		...
		printAppt($sql);
                ...
                while(list($eid, $title, $barcolor) = mysql_fetch_row($result)) {
                        ...
                        print("<img src=\"images/calendar/ball$barcolorchar.gif\" border=0>&nbsp;<a href=\"modules.php?op=modload&name=$module_name&file=index&type=view&eid=$eid\" $frame>$title</a><br>");
                }
...
function buildMonth($Date) {
	...
	OpenTable();
        ...
        if ($Date_Array[2] < 1970)
				...
				bgcolor=$selecteddaycolor border=0><TR><TD align=center><FONT SIZE=2><b><a

href=\"modules.php?op=modload&name=$module_name&file=index&Date=$Date_Array[0]/$day/$Date_Array[2]&type=day\">$day</a></b></TD></TR></TABLE>");
                        else
                                print("\n\t<TD valign=top><TABLE width=100% cellpadding=0 cellspacing=0 border=0><TR><TD
				align=center><FONT SIZE=2><b><a

href=\"modules.php?op=modload&name=$module_name&file=index&Date=$Date_Array[0]/$day/$Date_Array[2]&type=day\">$day</a></b></center></font></TD></TR></TABLE>");
                        ...
                        for ($i=0;$i<=$cellcount - 1;$i++) {
                                ...
                                if ($cellArray[$i] != "FALSE") {
                                        ...
                                        $tmpEndDate = mktime (0, 0, 0, $tmpEndDate_Array[1], $tmpEndDate_Array[2], $tmpEndDate_Array[0]);
                                        if ($textEvents) {
                                                echo "<font size=2><img src=\"images/calendar/ball$barcolorchar.gif\" border=0> <a href=\"modules.php?op=modload&name=$module_name&file=index&type=view&eid=$cellArray[$i]\" $frame>$cellArrayTitle[$i]</a></font><br>";
                                        } else {
                                                ...
                                                if (($cellDate == $tmpEndDate) && ($tmpEndDate == $tmpEventDate)) {
                                                        echo "<td><a href=\"modules.php?op=modload&name=$module_name&file=index&type=view&eid=$cellArray[$i]\" $frame $popuptext><img src=\"images/calendar/leftbar$barcolorchar.gif\" border=\"0\"></a></td>
                                                        <td align=\"right\" width=100% background=\"images/calendar/mainbar$barcolorchar.gif\"><a href=\"modules.php?op=modload&name=$module_name&file=index&type=view&eid=$cellArray[$i]\" $frame $popuptext><img src=\"images/calendar/mainbar2$barcolorchar.gif\" border=\"0\"></a></td>
                                                        <td align=\"right\"><a href=\"modules.php?op=modload&name=$module_name&file=index&type=view&eid=$cellArray[$i]\" $frame $popuptext><img src=\"images/calendar/rightbarcap$barcolorchar.gif\" border=\"0\"></a></td>";
                                                } elseif ($cellDate == $tmpEventDate) {
                                                        echo "<td><a href=\"modules.php?op=modload&name=$module_name&file=index&type=view&eid=$cellArray[$i]\" $frame $popuptext><img src=\"images/calendar/leftbar$barcolorchar.gif\" border=\"0\"></a></td>
                                                        <td align=\"center\" width=100% background=\"images/calendar/mainbar$barcolorchar.gif\"><a href=\"modules.php?op=modload&name=$module_name&file=index&type=view&eid=$cellArray[$i]\" $frame $popuptext><img src=\"images/calendar/mainbar2$barcolorchar.gif\" border=\"0\"></a></td>";
                                                } elseif ($cellDate == $tmpEndDate) {
                                                        echo "<td align=\"center\" width=100% background=\"images/calendar/mainbar$barcolorchar.gif\"><a href=\"modules.php?op=modload&name=$module_name&file=index&type=view&eid=$cellArray[$i]\" $frame $popuptext><img src=\"images/calendar/mainbar2$barcolorchar.gif\" border=\"0\"></a></td>
                                                        <td><a href=\"modules.php?op=modload&name=$module_name&file=index&type=view&eid=$cellArray[$i]\" $frame $popuptext><img src=\"images/calendar/rightbar$barcolorchar.gif\" border=\"0\"></a></td>";
                                                } else {
                                                        if ($day == 1) {
                                                                echo "<td><a href=\"modules.php?op=modload&name=$module_name&file=index&type=view&eid=$cellArray[$i]\" $frame $popuptext><img src=\"images/calendar/leftbar2$barcolorchar.gif\" border=\"0\"></a></td>
                                                                <td align=\"center\" width=99% background=\"images/calendar/mainbar$barcolorchar.gif\"><a href=\"modules.php?op=modload&name=$module_name&file=index&type=view&eid=$cellArray[$i]\" $frame $popuptext><img src=\"images/calendar/mainbar2$barcolorchar.gif\" border=\"0\"></a></td>";
                                                        } else {
                                                                echo "<td align=\"center\" background=\"images/calendar/mainbar$barcolorchar.gif\"><a href=\"modules.php?op=modload&name=$module_name&file=index&type=view&eid=$cellArray[$i]\" $frame $popuptext><img src=\"images/calendar/mainbar$barcolorchar.gif\" border=\"0\"></a></td>";
                                                        }
                                                }
                                        }
                                } else {
					...
					$startTime = getTime($startTime);
        				$endTime = getTime($endTime);
                                ...
                                echo "<font size=2><img src=\"images/calendar/ball$barcolorchar.gif\" border=0> <a href=\"modules.php?op=modload&name=$module_name&file=index&type=view&eid=$eid\" $frame>$startTime - $endTime<br> $title</a></font><br>";
                        }
        ...
        if ($Date_Array[2] < 1970)
                ...
                for ($day = 1 ; $day <= $Last_Day ; $day++) {
                        ...
                        while(list($eid, $title, $eventDate, $endDate, $barcolor) = mysql_fetch_row($result)) {
                                ...
                                echo "<font size=2><img src=\"images/calendar/ball$barcolorchar.gif\" border=0> <a href=\"modules.php?op=modload&name=$module_name&file=index&type=view&eid=$eid\" $frame>$title</a></font><br>";
                        }
                        mysql_free_result($result);
...
function viewEvent($eid) {
	...
	if ($useInternationalDates) {
		echo "<a href=\"modules.php?op=modload&name=$module_name&file=index&type=day&Date=$Date_Array[1]/$Date_Array[2]/$Date_Array[0]\">$Date_Array[2]/$Date_Array[1]/$Date_Array[0]</a><br>";
	} else {
         	echo "<a href=\"modules.php?op=modload&name=$module_name&file=index&type=day&Date=$Date_Array[1]/$Date_Array[2]/$Date_Array[0]\">$Date_Array[1]/$Date_Array[2]/$Date_Array[0]</a><br>";
	}
        if (strtotime($eventDate) != strtotime($endDate)) {
                echo "<font size=2><b>"._CALENDDATEPREVIEW."</b>: ";
		if ($useInternationalDates) {
			echo "<a href=\"modules.php?op=modload&name=$module_name&file=index&type=day&Date=$endDate_Array[1]/$endDate_Array[2]/$endDate_Array[0]\">$endDate_Array[2]/$endDate_Array[1]/$endDate_Array[0]</a><br>";
		} else {
                      	echo "<a href=\"modules.php?op=modload&name=$module_name&file=index&type=day&Date=$endDate_Array[1]/$endDate_Array[2]/$endDate_Array[0]\">$endDate_Array[1]/$endDate_Array[2]/$endDate_Array[0]</a><br>";
		}
        }
        if (is_admin($admin)) {
        ...
        echo "<b>"._CALARTICLETEXT."</b>:<br>$body<p></font></td>
                <td valign=\"top\"><img src=\"images/calendar/topics/$topicimage\" border=\"0\"></td>
              </tr>
              </table>
              <br><br>
...
function CalendarIndex($Date,$type,$eid) {
    ...
    $module_name,$eventsopeninnewwindow,$netscapeFriendlyMonthView,$useInternationalDates, $prefix;
                        ...
                        <td align=\"center\">
                                ...
                                <tr>
                                        <td width=20% valign=\"top\">
                                                <font size=\"2\"><strong><big>·</big></strong> <a href=\"modules.php?op=modload&name=$module_name&file=submit\">"._CALEVENTLINK."</a><br>
                                                <strong><big>·</big></strong> <a href=\"modules.php?op=modload&name=$module_name&file=index&type=day\">"._CALDAYLINK."</a>
                                        </td>
                                        <td width=20% valign=\"top\">
                                                <font size=\"2\"><strong><big>·</big></strong> <a href=\"modules.php?op=modload&name=$module_name&file=index&type=month\">"._CALMONTHLINK."</a><br>
                                                <strong><big>·</big></strong> <a href=\"modules.php?op=modload&name=$module_name&file=index&type=year\">"._CALYEARLINK."</a>
                                                </td>
                                        <td width=60% valign=\"top\">
                                                <form name=\"jump\">";
						echo "<font size=\"2\"><b>"._CALJUMPTOTEXT."</b>:<br>";
						if ($useInternationalDates) {
