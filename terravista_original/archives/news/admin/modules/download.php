...
$result = mysql_query("select radmindownload, radminsuper from $prefix"._authors." where aid='$aid'");
...
function downloads() {
    ...
    echo "<font size=\"2\">"._THEREARE." <b>$numrows</b> "._DOWNLOADSINDB."</font></center>";
    CloseTable();
    echo "<br>";
...
/* List Downloads waiting for validation */
    ...
    if ($numrows>0) {
	OpenTable();
	echo "<center><font size=\"3\"><b>"._DOWNLOADSWAITINGVAL."</b></font></center><br><br>";
...
/* Add a New Main Category */
    ...
    OpenTable();
    echo "<center><font size=\"2\">[ <a href=\"admin.php?op=DownloadsCleanVotes\">"._CLEANDOWNLOADSDB."</a> | "
...
// Add a New Download to Database
	...
	OpenTable();
	echo "<form method=\"post\" action=\"admin.php\">"
	    ."<font size=\"3\"><b>"._ADDNEWDOWNLOAD."</b><br><br>"
...
// Modify Downloads
    ...
    OpenTable();
    echo "<form method=\"post\" action=\"admin.php\">"
	."<font size=\"3\"><b>"._MODDOWNLOAD."</b><br><br>"
...
function DownloadsModDownload($lid) {
    ...
    OpenTable();
    echo "<center><font size=\"4\"><b>"._WEBDOWNLOADSADMIN."</b></font></center>";
    CloseTable();
    echo "<br>";
    OpenTable();
    echo "<center><font size=\"3\"><b>"._MODDOWNLOAD."</b></font></center><br><br>";
...
function DownloadsListBrokenDownloads() {
    ...
    $totalbrokendownloads = mysql_num_rows($result);
    echo "<center><font size=\"3\"><b>"._DUSERREPBROKEN." ($totalbrokendownloads)</b></font></center><br><br><center>"
	.""._DIGNOREINFO."<br>"
	.""._DDELETEINFO."</center><br><br><br>"
	."<table align=\"center\" width=\"450\">";
    if ($totalbrokendownloads==0) {
	echo "<center><font size=\"3\">"._DNOREPORTEDBROKEN."</font></center><br><br><br>";
    } else {
...
function DownloadsListModRequests() {
    ...
    echo "<center><font size=\"3\"><b>"._DUSERMODREQUEST." ($totalmodrequests)</b></font></center><br><br><br>";
	...
	list($owneremail)=mysql_fetch_row($result8);    
    	...
    	echo "<table border=\"1\" bordercolor=\"black\" cellpadding=\"5\" cellspacing=\"0\" align=\"center\" width=\"450\">"
    	    ...
    	    ."<td rowspan=\"10\" valign=\"top\" align=\"left\"><font size=\"1\"><br>"._DESCRIPTION.":<br>$origdescription</font></td>"
    	    ."</tr>"
	    ...
	    ."<tr><td valign=\"top\" width=\"45%\"><font size=\"1\">"._AUTHORNAME.": $origname</td></tr>"
	    ."<tr><td valign=\"top\" width=\"45%\"><font size=\"1\">"._AUTHOREMAIL.": $origemail</td></tr>"
	    ."<tr><td valign=\"top\" width=\"45%\"><font size=\"1\">"._FILESIZE.": $origfilesize</td></tr>"
	    ."<tr><td valign=\"top\" width=\"45%\"><font size=\"1\">"._VERSION.": $origversion</td></tr>"
	    ."<tr><td valign=\"top\" width=\"45%\"><font size=\"1\">"._HOMEPAGE.": <a href=\"$orighomepage\" target=\"new\">$orighomepage</a></td></tr>"
    	    ."</table>"
    	    ."</td>"
    	    ."</tr>"
    	    ."<tr>"
    	    ...
    	    ."<td rowspan=\"10\" valign=\"top\" align=\"left\"><font size=\"1\"><br>"._DESCRIPTION.":<br>$description</font></td>"
    	    ."</tr>"
	    ...
	    ."<tr><td valign=\"top\" width=\"45%\"><font size=\"1\">"._AUTHORNAME.": $name</td></tr>"
	    ."<tr><td valign=\"top\" width=\"45%\"><font size=\"1\">"._AUTHOREMAIL.": $email</td></tr>"
	    ."<tr><td valign=\"top\" width=\"45%\"><font size=\"1\">"._FILESIZE.": $filesize</td></tr>"
	    ."<tr><td valign=\"top\" width=\"45%\"><font size=\"1\">"._VERSION.": $version</td></tr>"
	    ."<tr><td valign=\"top\" width=\"45%\"><font size=\"1\">"._HOMEPAGE.": <a href=\"$homepage\" target=\"new\">$homepage</a></td></tr>"
    	    ."</table>"
    	    ."</td>"
    	    ."</tr>"
    	    ."</table>"
    	...
    	echo "<td align=\"right\"><font size=\"1\">( <a href=\"admin.php?op=DownloadsChangeModRequests&amp;requestid=$requestid\">"._ACCEPT."</a> / <a href=\"admin.php?op=DownloadsChangeIgnoreRequests&amp;requestid=$requestid\">"._IGNORE."</a> )</font></td></tr></table><br><br>";
    }
...
function DownloadsDownloadCheck() {
    ...
    echo "<br>";
    OpenTable();
    echo "<center><font size=\"3\"><b>"._DOWNLOADVALIDATION."</b></font></center><br>"
...
function DownloadsValidate($cid, $sid, $ttitle) {
	...
	if (!$fp){ 
		...
		."<td align=\"center\"><font size=\"2\">&nbsp;&nbsp;[ <a href=\"admin.php?op=DownloadsModDownload&amp;lid=$lid\">"._EDIT."</a> | <a href=\"admin.php?op=DownloadsDelDownload&amp;lid=$lid\">"._DELETE."</a> ]&nbsp;&nbsp;</font>"
		."</td></tr>";
	}		
	if ($fp){ 
