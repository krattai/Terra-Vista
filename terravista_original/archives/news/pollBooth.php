...
if(!isset($pollID)) {
  ...
  pollCollector($pollID, $voteID, $forwarder);
    ...
    include ("header.php");
    OpenTable();
    echo "<center><font size=\"4\"><b>"._CURRENTPOLLRESULTS."</b></font></center>";
    CloseTable();
    echo "<br>";
    OpenTable2();
    pollResults($pollID);
    ...
    include ('header.php');
    OpenTable();
    echo "<center><font size=\"3\"><b>"._SURVEY."</b></font></center>";
    CloseTable();
    echo "<br><br>";
    ...
    include ('header.php');
    OpenTable();
    echo "<center><font size=\"3\"><b>"._CURRENTSURVEY."</b></font></center>";
    CloseTable();
