...
$unum = mysql_num_rows(mysql_query("select * from $prefix"._users.""));
$anum = mysql_num_rows(mysql_query("select * from $prefix"._authors.""));
$snum = mysql_num_rows(mysql_query("select * from $prefix"._stories.""));
$cnum = mysql_num_rows(mysql_query("select * from $prefix"._comments.""));
$secnum = mysql_num_rows(mysql_query("select * from $prefix"._sections.""));
$secanum = mysql_num_rows(mysql_query("select * from $prefix"._seccont.""));
$subnum = mysql_num_rows(mysql_query("select * from $prefix"._queue.""));
