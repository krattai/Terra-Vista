...
function FriendSend($sid) {
    ...
    OpenTable();
    echo "<font size=4><b>"._FRIEND."</b></font><br><br>"
...
function StorySent($title, $fname) {
    ...
    OpenTable();
    echo "<center><font size=\"2\">"._STORY." <b>$title</b> "._HASSENT." $fname... "._THANKS."</font></center>";
    CloseTable();
    include ("footer.php");
}
...
function RecommendSite() {
    ...
    include ("header.php");
    OpenTable();
    echo "<font size=\"4\"><b>"._RECOMMEND."</b></font><br><br>"
	."<form action=\"friend.php\" method=\"post\">"
...
function SiteSent($fname) {
    include ('header.php');
    OpenTable();
    echo "<center><font size=\"2\">"._FREFERENCE." $fname...<br><br>"._THANKSREC."</font></center>";
    CloseTable();
    include ('footer.php');
}
