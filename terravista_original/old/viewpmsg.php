...
if (!is_user($user)) {
    ...
    OpenTable();
    echo "<center><font size=\"3\"><b>"._PRIVATEMESSAGES."</b></font></center>";
    CloseTable();
	...
	."<td><font size=\"2\" color=\"$textcolor2\"><b>"._FROM."</b></font></td>"
	."<td align=\"center\"><font size=\"2\" color=\"$textcolor\"><b>"._SUBJECT."</b></font></td>"
	."<td align=\"center\"><font size=\"2\" color=\"$textcolor2\"><b>"._DATE."</b></font></td>"
	."</tr>";
	...
	while ($myrow = mysql_fetch_array($resultID)) {
		...
		."<td bgcolor=\"$bgcolor3\" valign=\"middle\"><font size=\"1\" color=\"$textcolor2\">$myrow[subject]</font></td>"
		."<td bgcolor=\"$bgcolor1\" valign=\"middle\" align=\"center\" width=\"20%\"><font size=\"1\" color=\"$textcolor2\">$myrow[msg_time]</font></td></tr>";
	    $count++;
	}
	if ($display) {
