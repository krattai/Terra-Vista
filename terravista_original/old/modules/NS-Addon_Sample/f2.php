...
function f2one() {
    ...
    echo "<ul>";
    echo "<li><a href=\"modules.php?op=modload&amp;name=NS-Addon_Sample&amp;file=f2&amp;func=f2go\">f2.php Main</a>";
...
function f2go() {
    ...
    echo "<ul>";
    echo "<li><a href=\"modules.php?op=modload&amp;name=NS-Addon_Sample&amp;file=f2&amp;func=f2one\">Function f2one</a>";
    echo "<li><a href=\"modules.php?op=modload&amp;name=NS-Addon_Sample&amp;file=index&amp;func=dos\">Go to index.php</a>";
    echo "</ul>";
