...
function themeheader() {
	...
	."<table border=\"0 cellpadding=\"4\" cellspacing=\"0\" width=\"100%\" align=\"center\"><tr><td bgcolor=\"ffffff\">"
        ...
        ."<a href=\"index.php\"><img src=\"themes/uveais/images/logo.gif\" Alt=\"".translate("Welcome to")." $sitename\" border=\"0\"></a>"
        ."</td><td align=\"right\">"
        ."<form action=\"search.php\" method=\"post\">"
        ."<font size=\"2\">".translate("Search").""
...
function themesidebox($title, $content) {
    echo "<table border=\"0\" cellspacing=\"0\" cellpadding=\"0\" width=\"150\" bgcolor=\"000000\"><tr><td>"
        ...
        ."<font size=\"2\">$title</font></td></tr><tr><td bgcolor=\"ffffff\"><font size=\"2\">"
        ."$content"
