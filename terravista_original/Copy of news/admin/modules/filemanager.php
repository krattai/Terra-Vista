...
function html_header(){
    ...
    OpenTable();
    echo "<center><font size=\"4\"><b>"._FILEMANAGER."</b></font></center>";
    CloseTable();
    echo "<br>";
    OpenTable();
...
function displaydir() {
    ...
    echo "<tr>";
    echo "<th><font size=\"1\">PHP-Nuke File Manager is Based on <a href=\"http://www.suneworld.com\">WebExplorer</a> and has been integrated with the author permission.<br>The code integrated on PHP-Nuke is licensed under the GPL.</font></th>";
    echo "</tr></table>";
    CloseTable();
}
