...
function viewlink($cid, $min, $orderby, $show) {
    ...
    $result=mysql_query("select lid, title, description, date, hits, linkratingsummary, totalvotes, totalcomments from $prefix"._links_links." where cid=$cid AND sid=0 order by $orderby limit $min,$perpage ");
...
function viewslink($sid, $min, $orderby, $show) {
	...
	."<br><b>"._SITESSORTED.": $orderbyTrans</b></font></center><br><br>";
    $result=mysql_query("select lid, url, title, description, date, hits, linkratingsummary, totalvotes, totalcomments from $prefix"._links_links." where sid=$sid order by $orderby limit $min,$perpage");
...
function outsidelinksetup($lid) {
    ...
    <center>
    <form action=\"links.php\" mathod=\"post\">\n
