// Java Script Windows v1.0.0
// http://www.thebix.com / Ivan Strigo - istrigo@thebix.com
// You can modify script and send me back your mods. 
// Copying, modifying and distributing Under GPL
// ------------------------------------------------------------------------------------
// Do not touch anything below this line if you don`t know exactly what are you doing 
// ------------------------------------------------------------------------------------

function openwindow(theURL, wname, W, H, windowCERRARa, windowCERRARd, windowCERRARo, windowNONEgrf, windowCLOCK, windowTIT, windowREALtit , windowBORDERCOLOR, windowBORDERCOLORsel, windowTITBGCOLOR, windowTITBGCOLORsel) {
...
'<html>																							'+ '\n'+
'<head>                                                                                                                                                                         	'+ '\n'+
'<title>&nbsp;TheBix.com - Java Script Windows v1.0.0</title>                                                                                                                      		'+ '\n'+
'<style type="text/css">                                                                                                                                                        	'+ '\n'+
'#mywindowTITLE 	{ position: absolute; left:   10px; top:   0px; width: 100%; height: 22px; z-index: 1; background: '+windowTITBGCOLOR+'; clip:rect(0,100%,22,0); }         '+ '\n'+
'#mywindow 		{ position: absolute; left:   2px; top:   2px; width: 100%; height: 22px; z-index: 2;                            	      clip:rect(0,100%;22,0); }         '+ '\n'+
...
'</script>                                                                                												'+ '\n'+
'</head>                                                                                                                                                                        	'+ '\n'+
'<body TOPMARGIN=0 LEFTMARGIN=0 MARGINWIDTH=0 MARGINHEIGHT=0 scroll=no style="border: 1px solid '+ windowBORDERCOLOR +'; overflow: hidden; margin: 0pt;" background='+windowTITBGCOLOR+'>  '+ '\n'+
'<div id=mywindow><img src="'+windowNONEgrf+'"></div>                                                                                                             	'+ '\n'+
