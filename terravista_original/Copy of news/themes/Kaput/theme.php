...
function themeheader() {
	...
	."<td align=right width=100%>"
        ...
        ."<font size=\"2\" color=\"#000000\"><b>"._SEARCH." </b>"
...
function themearticle ($aid, $informant, $datetime, $title, $thetext, $topic, $topicname, $topicimage, $topictext) {
    ...
    echo "<font size=\"3\" color=\"#363636\"><b>$title</b></font><br>\n"
        ."<font size=\"2\">".translate('Posted on')." $datetime by ";
    formatAidHeader($aid);
    if (is_admin($admin)) {
...
function themesidebox($title, $content) {
	...
	."<td width=17 height=17><img src=themes/Kaput/images/up-left.gif alt=\"\" border=0></td>"
        ...
        ."<td background=themes/Kaput/images/backdot.gif width=126><center><font size=2><b>$title</b></font></center><br>";
